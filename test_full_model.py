...
parser.add_argument('--content_dir', type=str, default = r"./content_anime",
                    help='Directory path to a batch of content images')
parser.add_argument('--style', type=str,
                    help='File path to the style image, or multiple style \
                    images separated by commas if you want to do \
                    style interpolation')
parser.add_argument('--style_dir', type=str, default = r"./style_anime",
...
parser.add_argument('--output', type=str, default = r"./outputs_anime",
...
vgg.load_state_dict(torch.load(args.vgg, map_location=torch.device('cpu')))
discriminator.load_state_dict(torch.load(args.discriminator, map_location=torch.device('cpu')))
